    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="btn-group float-right"><a
                        href="<?= base_url; ?>/buku/tambah" class="btn float-right btn-xs btn btn-primary">Tambah Buku</a>
                    <a href="<?= base_url; ?>/buku/laporan" class="btn float-right btn-xs btn btn-info">Laporan Buku</a>
                    <a href="<?= base_url; ?>/buku/lihatlaporan" class="btn float-right btn-xs btn btn-warning">Lihat Laporan Buku</a>
                </div>
